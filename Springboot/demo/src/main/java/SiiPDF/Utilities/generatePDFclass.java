...
public class generatePDFclass{
    ...
    public static void main(String[] args) throws Exception {
        try (
            InputStream xmlFile = new FileInputStream("test_files/In/NotaDeCreditoDeExportacionElectronica_69.xml");
            InputStream xslFile = new FileInputStream("src/main/java/SiiPDF/plantilla_PDF_DX.xsl");
            OutputStream pdfFile = new FileOutputStream("test_files/test_pdf_dx.pdf")
        ) {
