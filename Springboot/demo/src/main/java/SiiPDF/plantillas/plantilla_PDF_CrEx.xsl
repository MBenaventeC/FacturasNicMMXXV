...
<xsl:stylesheet version="1.1"
	...
	<!-- Cambia el template raíz para usar Exportaciones -->
	<xsl:template match="/">
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:page-sequence master-reference="simple">
				<fo:flow flow-name="xsl-region-body">
					<xsl:apply-templates select="DTE/Exportaciones" />
				</fo:flow>
			</fo:page-sequence>
		</fo:root>
	</xsl:template>

	<!-- Template principal para Exportaciones -->
	<xsl:template match="Exportaciones">
		<fo:block>
			...
			<fo:block-container absolute-position="absolute" left="0cm" top="12cm" width="19cm">
				<fo:block font-size="8pt" font-family="monospace" color="black" text-align="left">
					<fo:table table-layout="fixed" width="100%" border-width="0.5pt" border-style="solid" border-collapse="collapse">
						...
						<fo:table-body>
							<fo:table-row>
								<fo:table-cell text-align="center" border-width="0.5pt" border-style="solid">
									<fo:block><fo:inline font-weight="bold">Tipo Doc.</fo:inline></fo:block>
								</fo:table-cell>
								<fo:table-cell text-align="center" border-width="0.5pt" border-style="solid">
									<fo:block><fo:inline font-weight="bold">Razón Referencia</fo:inline></fo:block>
								</fo:table-cell>
								<fo:table-cell text-align="center" border-width="0.5pt" border-style="solid">
									<fo:block><fo:inline font-weight="bold">Folio</fo:inline></fo:block>
								</fo:table-cell>
								<fo:table-cell text-align="center" border-width="0.5pt" border-style="solid">
									<fo:block><fo:inline font-weight="bold">Fecha</fo:inline></fo:block>
								</fo:table-cell>
								<fo:table-cell text-align="center" border-width="0.5pt" border-style="solid">
									<fo:block><fo:inline font-weight="bold">Código Ref.</fo:inline></fo:block>
								</fo:table-cell>
							</fo:table-row>
			...
			<!-- Totales y moneda -->
			<fo:block-container absolute-position="absolute" left="12.25cm" top="17cm" width="6.75cm">
				<fo:block font-size="8pt" font-family="monospace" color="black" text-align="left">
					<fo:table table-layout="fixed" width="7cm" border-width="0.5pt" border-style="solid" border-collapse="collapse">
						<fo:table-column column-width="3.25cm" />
						<fo:table-column column-width="3.5cm" />
						<fo:table-body>
							<fo:table-row>
								<fo:table-cell text-align="center" border-width="0.5pt" border-style="solid" height="1cm">
									<fo:block><fo:inline font-weight="bold">Monto Exento</fo:inline></fo:block>
								</fo:table-cell>
								<fo:table-cell text-align="center" border-width="0.5pt" border-style="solid" height="1cm">
									<fo:block><fo:inline font-weight="bold"><xsl:value-of select="Encabezado/Totales/MntExe"/></fo:inline></fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
								<fo:table-cell text-align="center" border-width="0.5pt" border-style="solid" height="1cm">
								...
								<fo:table-cell text-align="center" border-width="0.5pt" border-style="solid" height="1cm">
									<fo:block><fo:inline font-weight="bold"><xsl:value-of select="Encabezado/Totales/MntTotal"/></fo:inline></fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
								<fo:table-cell text-align="center" border-width="0.5pt" border-style="solid" height="1cm">
									<fo:block><fo:inline font-weight="bold">Dólar Observado</fo:inline></fo:block>
								</fo:table-cell>
								<fo:table-cell text-align="center" border-width="0.5pt" border-style="solid" height="1cm">
									<fo:block><fo:inline font-weight="bold"><xsl:value-of select="Encabezado/OtraMoneda/TpoCambio"/></fo:inline></fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
								<fo:table-cell text-align="center" border-width="0.5pt" border-style="solid" height="1cm">
									<fo:block><fo:inline font-weight="bold">Total en pesos</fo:inline></fo:block>
								</fo:table-cell>
								<fo:table-cell text-align="center" border-width="0.5pt" border-style="solid" height="1cm">
									<fo:block><fo:inline font-weight="bold"><xsl:value-of select="Encabezado/OtraMoneda/MntTotOtrMnda"/></fo:inline></fo:block>
								</fo:table-cell>
							</fo:table-row>
						</fo:table-body>
					</fo:table>
