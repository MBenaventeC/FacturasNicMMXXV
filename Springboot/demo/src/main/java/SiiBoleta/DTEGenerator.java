...
public class DTEGenerator {
    ...
    public static String Generate(String name, JSONObject jsonDoc, String folios) throws Exception {
        ...
        InputStream xmlFile = new FileInputStream("src/main/resources/out/DTE.xml");
        InputStream xslFile = new FileInputStream("src/main/resources/In/plantillas/plantilla_PDF_FExE.xsl");
        OutputStream pdfFile = new FileOutputStream("src/main/resources/out/" + id + ".pdf");
