...
public class test {
    public static void main(String[] args) throws Exception {
        ...
        //Genera SetDTE vacío
        String SetDTE = SetDTEGenerator.Generate("src/main/resources/out/SetDTE", jsonDTEs);
        ...
        for (int i=0;i<jsonDTEs.length();i++){
            ...
            //Genera DTE
            System.out.println("cwd = " + System.getProperty("user.dir"));
            String DTE = DTEGenerator.Generate("DTE",jsonDTE, "src/main/resources/FoliosSII609100003422295202510171815.xml");
            //firma DTE
        ...
        String envio = insertDTEs.Insert(SetDTE,SignedDTEs,"src/main/resources/out/envio");
        //Firma envio
        String signedEnv = signEnvio.sign(envio,"src/main/resources/out/signedEnv.xml","SetDoc");
        String Fixed =  signEnvio.Fix(signedEnv,"src/main/resources/out/signedEnvFixed");

        System.out.println("Envio DTE firmado: "+ Fixed);
        File DTEXML = new File("src/main/resources/out/DTE.xml");
        File envioXML = new File("src/main/resources/out/envio.xml");
        File setXML = new File("src/main/resources/out/SetDTE.xml");
        File signedEnvXML = new File("src/main/resources/out/signedEnv.xml");
        DTEXML.delete();
        envioXML.delete();
        setXML.delete();
        signedEnvXML.delete();
